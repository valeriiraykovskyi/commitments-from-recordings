...
Created 2026-09-17T00:19:57.299Z. Git `ea8052f` (with uncommitted changes). Prompt 2026-09-17.5.
...
|---|---|---|---|---|---|---|---|---|
| t1-launch-sync | 3/3 | ok | 13.5 s / 15.6 s | 11.4 s / 13.4 s | 1 / 1 | $0.0095 / $0.0096 | $0.0114 | $0.0079 |
| t2-migration-kept | 3/3 | ok | 16.3 s / 18.0 s | 14.2 s / 16.0 s | 1 / 1 | $0.0099 / $0.0100 | $0.0122 | $0.0082 |
| t3-no-intros-hedged | 3/3 | ok | 14.3 s / 15.3 s | 12.3 s / 13.7 s | 1 / 2 | $0.0067 / $0.0069 | $0.0085 | $0.0087 |
| g1-too-long | 3/3 | declined (too_long) | 0.0 s / 0.0 s | 0.0 s / 0.0 s | 0 / 0 | $0.0000 / $0.0000 | $0.0000 | $0.0000 |
| g2-spanish | 3/3 | declined (unsupported_language) | 0.3 s / 1.2 s | 0.0 s / 0.0 s | 0 / 0 | $0.0017 / $0.0017 | $0.0017 | $0.0063 |
...
|---|---|---|---|---|---|---|---|---|---|
| t1-launch-sync | 1 | yes | ok | 13.4 s | 2.1 s | 11.3 s | 1 | 1627 (1408) / 3115 (2117) | $0.0095 / $0.0114 |
| t1-launch-sync | 2 | yes | ok | 15.6 s | 2.2 s | 13.4 s | 1 | 1627 (1408) / 3318 (2175) | $0.0096 / $0.0116 |
| t1-launch-sync | 3 | yes | ok | 13.5 s | 2.1 s | 11.4 s | 1 | 1627 (1408) / 2975 (1901) | $0.0094 / $0.0112 |
| t2-migration-kept | 1 | yes | ok | 18.0 s | 2.0 s | 16.0 s | 1 | 1623 (1408) / 4006 (2970) | $0.0100 / $0.0125 |
| t2-migration-kept | 2 | yes | ok | 15.3 s | 2.0 s | 13.3 s | 1 | 1623 (1408) / 3492 (2445) | $0.0097 / $0.0118 |
| t2-migration-kept | 3 | yes | ok | 16.3 s | 2.1 s | 14.2 s | 1 | 1623 (1408) / 3769 (2716) | $0.0099 / $0.0122 |
| t3-no-intros-hedged | 1 | yes | ok | 15.3 s | 1.6 s | 13.7 s | 2 | 3502 (2688) / 3300 (2264) | $0.0069 / $0.0090 |
| t3-no-intros-hedged | 2 | yes | ok | 14.3 s | 2.0 s | 12.3 s | 1 | 1466 (1280) / 3050 (2419) | $0.0067 / $0.0085 |
| t3-no-intros-hedged | 3 | yes | ok | 8.5 s | 1.7 s | 6.9 s | 1 | 1466 (1280) / 1722 (1148) | $0.0059 / $0.0069 |
...
| g2-spanish | 1 | yes | declined (unsupported_language) | 1.2 s | 1.2 s | 0.0 s | 0 | — | $0.0017 / $0.0017 |
| g2-spanish | 2 | yes | declined (unsupported_language) | 0.3 s | 0.3 s | 0.0 s | 0 | — | $0.0017 / $0.0017 |
| g2-spanish | 3 | yes | declined (unsupported_language) | 0.2 s | 0.2 s | 0.0 s | 0 | — | $0.0017 / $0.0017 |
...
- [task/agreed] Set up analytics on the landing page — owner Mark, deadline "by Wednesday", flags date_not_stated — requested @ 16.5–19.6 s, committed @ 19.8–22.3 s, deadline @ 21.3–22.3 s
- [task/agreed] Write the release notes — owner Anna, deadline "Monday", flags date_not_stated, deadline_changed — committed @ 23.5–25.7 s, deadline @ 24.8–25.7 s, deadline @ 56.3–57.7 s, accepted @ 58.3–59.6 s
- [task/agreed] Write a migration script for the old beta users — owner Mark, flags no_deadline — committed @ 26.2–29.3 s, accepted @ 30.1–31.0 s
